...
class Researchassistant extends person
{
	...
	Researchassistant(int a,String b,String c,char d,String e,int f,double g)
	{
		super(a,b,c,d);
		program=e;
		year=f;
...
{
	private String desig,course;
		
	faculty(String a,String b,String c,String d,int e,String f,String g)
	{
		super(a,b,c,d,e);
		desig=f;
		course=g;
